...
uplink-tcminer-desc = Contains a flatpack with telecrystal miner, A very loud machine that uses bluespace blockchain technology to generate telecrystals every 30 seconds when powered. Requires 20kW of energy and a connection to the primary station's grid. Multitool not included.
