...
server-currency-name-singular = Penny
server-currency-name-plural = Pennies
...
gs-balanceui-shop-buy-token-antag = Buy an Antag Token - {$price} Pennies
gs-balanceui-shop-buy-token-admin-abuse = Buy an Admin Abuse Token - {$price} Pennies
gs-balanceui-shop-buy-token-hat = Buy a Hat Token - {$price} Pennies
