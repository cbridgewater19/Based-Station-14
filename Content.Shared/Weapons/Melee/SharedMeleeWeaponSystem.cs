...
public abstract class SharedMeleeWeaponSystem : EntitySystem
{
    ...
    public virtual void DoLightAttack(EntityUid user, LightAttackEvent ev, EntityUid meleeUid, MeleeWeaponComponent component, ICommonSession? session) // Goobstation - Edit
    {
        ...
        var damage = GetDamage(meleeUid, user, component) * GetClickDamageModifier(meleeUid, user, component);
    ...
    private bool DoHeavyAttack(EntityUid user, HeavyAttackEvent ev, EntityUid meleeUid, MeleeWeaponComponent component, ICommonSession? session)
    {
        ...
        var damage = GetDamage(meleeUid, user, component) * GetWideSwingDamageModifier(meleeUid, user, component);
    ...
    protected virtual FixedPoint2 GetClickDamageModifier(EntityUid meleeUid, EntityUid user, MeleeWeaponComponent component)
    {
        return component.ClickDamageModifier;
    }

    protected virtual FixedPoint2 GetWideSwingDamageModifier(EntityUid meleeUid, EntityUid user, MeleeWeaponComponent component)
    {
        return component.WideSwingDamageModifier;
    }
}
