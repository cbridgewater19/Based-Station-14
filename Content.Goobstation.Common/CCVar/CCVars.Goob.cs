...
public sealed partial class GoobCVars
{
    ...
    public static readonly CVarDef<int> PenniesPerPlayer =
        CVarDef.Create("goob.pennies_per_player", 10, CVar.SERVERONLY);

    public static readonly CVarDef<int> PenniesPerGreentext =
        CVarDef.Create("goob.pennies_per_greentext", 5, CVar.SERVERONLY);

    public static readonly CVarDef<float> PennyGreentextMultiplier =
        CVarDef.Create("goob.penny_greentext_multiplier", 1.5f, CVar.SERVERONLY);

    public static readonly CVarDef<int> PennyNonAntagMultiplier =
        CVarDef.Create("goob.penny_non_antag_multiplier", 1, CVar.SERVERONLY);

    public static readonly CVarDef<int> PennyServerMultiplier =
        CVarDef.Create("goob.penny_server_multiplier", 1, CVar.SERVERONLY);

    public static readonly CVarDef<int> PennyMinPlayers =
        CVarDef.Create("goob.penny_min_players", 1, CVar.SERVERONLY);

    public static readonly CVarDef<int> PennyEvacuationMultiplier =
        CVarDef.Create("goob.penny_evacuation_multiplier", 3, CVar.SERVERONLY);
