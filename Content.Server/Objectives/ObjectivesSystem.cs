...
public sealed class ObjectivesSystem : SharedObjectivesSystem
{
    ...
    [Dependency] private readonly ServerCurrencySystem _currencySystem = default!;
                ...
                foreach (var objective in objectiveGroup)
                {
                    ...
                    else if (progress > 0.99f)
                    {
                        ...
                        completedObjectives++;
                         ...
                         // Register player for greentext multiplier instead of fixed pennies
                        if(userid.HasValue)
                        {
                            _currencySystem.RegisterGreentextCompletion(userid.Value);
                        }
                    }
